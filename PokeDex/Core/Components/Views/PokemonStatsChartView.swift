...
struct PokemonStatsChartView: View {
    ...
    let markColors: [LinearGradient] = [
        LinearGradient(colors: [Color.Stats.hpoint, Color.Stats.hpoint.adjust(brightness: -0.30)], startPoint: .leading, endPoint: .trailing),
        ...
        LinearGradient(colors: [Color.Stats.specialAttack, Color.Stats.specialAttack.adjust(brightness: -0.30)],
                       startPoint: .leading,
                       endPoint: .trailing),
    ...
    var body: some View {
        VStack {
            ...
            .padding(.horizontal)
            .onAppear {
                self.data = [ChartData(type: "Hp", count: stats.hpoint),
